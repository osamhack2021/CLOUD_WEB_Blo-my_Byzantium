...
var dirname = "/workspaces/CLOUD_WEB_Blo-my_Byzantium/CLOUD(BE)/fabric-samples/test-network/organizations/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/keystore/"
var filename = fs.readdirSync(dirname).filter(fn => fn.endsWith('_sk'));
var tempdirname = dirname.replace("/workspaces/CLOUD_WEB_Blo-my_Byzantium/CLOUD(BE)/fabric-samples/test-network/organizations", "/tmp/crypto");
